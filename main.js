...
/* harmony export */   "navMenuBtn": () => (/* binding */ navMenuBtn)
/* harmony export */ });
...
function navLogo(logo) {
  var navLogo = document.createElement("h2");
  navLogo.textContent = logo;
  return navLogo;
}
function navMenuBtn(symbol) {
  var navMenuBtn = document.createElement("span");
  ...
  navMenuBtn.onclick = function () {
    ...
    console.log((0,_Sidebar__WEBPACK_IMPORTED_MODULE_0__["default"])().classList);
  };
  return navMenuBtn;
}
function Navbar() {
...
/* harmony export */   "clearProjectContainer": () => (/* binding */ clearProjectContainer),
/* harmony export */   "createPageHeader": () => (/* binding */ createPageHeader),
/* harmony export */   "default": () => (/* binding */ ProjectSection),
/* harmony export */   "getCurrentProjectIndex": () => (/* binding */ getCurrentProjectIndex),
/* harmony export */   "removeTasks": () => (/* binding */ removeTasks),
/* harmony export */   "showCurrentTabContent": () => (/* binding */ showCurrentTabContent)
/* harmony export */ });
/* harmony import */ var _Sidebar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Sidebar */ "./src/components/Sidebar.js");
...
function createPageHeader(headerName) {
  ...
  pageHeaderTitle.classList.add("project__text--title", "project__text--header");
...
function ProjectSection(project) {
  ...
  var projectEdit = new Image();
  projectEdit.src = _assets_edit_png__WEBPACK_IMPORTED_MODULE_1__;
  projectEdit.classList.add("sidebar__icon", "sidebar__icon--small");
  var projectDelete = new Image();
...
function showEmptyInbox(project, projectContainer) {
  projectContainer.append(emptyText("You have no current tasks for this project"));
...
function ShowProjectContent(project) {
  ...
  var incoming = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
...
function createTaskContainer(tasks, project, projectContainer, today, incoming) {
  tasks.map(function (element) {
    ...
    if (!today && !incoming) {
      ...
      if (element.date === (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "yyyy-MM-dd")) {
        createTaskBlock(element, project, projectContainer);
      }
    } else if (incoming) {
      if (element.date > (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "yyyy-MM-dd")) {
...
function createTaskBlock(element, project) {
  var projectContainer = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document.querySelector("project__container");
  ...
  taskPriority.classList.add(checkPriority(element.prio), "task__input", "task__input--select", "task__input--prio");
  ...
  taskDelete.onclick = function () {
    var projectSection = document.querySelector("#sectionContainer");
    // remove from DOM
    taskContainer.remove();

    // App Logic
    var currentTask = function currentTask(task) {
      return task.id === element.id;
    };
    var currentIndex = project.tasks.findIndex(currentTask);
    // remove from app
...
function checkPriority(priority) {
  if (priority === "High Priority") return "option--high";else if (priority === "Medium Priority") return "option--medium";else if (priority === "Low Priority") return "option--low";
}
function emptyText(text) {
  var projectEmpty = document.createElement("h2");
...
function createAddTaskBtn(project, projectContainer) {
  var projectAddTaskBtn = document.createElement("button");
  projectAddTaskBtn.classList.add("project__button--add", "project__button");
  var addProjectIcon = document.createElement("span");
...
function createAddTask(project, projectContainer) {
  ...
  var taskPriority = document.createElement("select");
  taskPriority.classList.add("task__input", "task__input--select", "task__input--prio");
  taskPriority.id = "taskPriority";
  // add priority
  taskPriority.add(addTaskPriority("Select Priority", "option", "disabled", "true"));
  ...
  taskPriority.onload = function () {
    setTaskPriorityColor(taskPriority);
  };
  taskPriority.oninput = function () {
    setTaskPriorityColor(taskPriority);
  };
  var currentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(), "yyyy-MM-dd");
  var taskDate = document.createElement("input");
  taskDate.classList.add("task__input", "task__input--select");
  taskDate.type = "date";
  ...
  selectContainer.classList.add("task__container--select");
  selectContainer.append(taskPriority, taskDate);
  taskDate.onclick = function () {
    return taskDate.value = currentDate;
  };
  ...
  mainTaskContainer.append(taskContainer, createAddTaskOptions(project, projectContainer));
  ...
  function createAddTaskOptions(project, projectContainer) {
    ...
    taskAddBtn.onclick = function () {
      ...
      if (project.name === "General Tasks") {
        (0,_Sidebar__WEBPACK_IMPORTED_MODULE_0__.addProject)("General Tasks");
        (0,_Sidebar__WEBPACK_IMPORTED_MODULE_0__.addProjectsToDOM)();
      }
...
function updateTask(element, project, projectContainer) {
  ...
  taskPriority.id = "taskPriority";
  // add priority
  taskPriority.add(addTaskPriority("Select Priority", "option", "disabled", ""));
  taskPriority.add(addTaskPriority("High Priority", "option--high"));
  taskPriority.add(addTaskPriority("Medium Priority", "option--medium"));
  taskPriority.add(addTaskPriority("Low Priority", "option--low"));
  var taskPriorityArray = Array.from(taskPriority.children);
  var selectedPriority = taskPriorityArray.find(function (choice) {
    return choice.value === element.prio;
  });
...
function addTaskPriority(priority, className) {
...
function addToProjectTasks(project, name) {
  ...
  var input = arguments.length > 5 ? arguments[5] : undefined;
  var projectContainer = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : document.querySelector("project__container");
  var inputElements = [name, prio, date];
  var valid = true;
  ...
  var validation = inputElements.every(validate);
...
function createAddTaskBtnRow(project) {
  var projectContainer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document.querySelector("project__container");
  var addTaskBtnRow = document.createElement("button");
...
function showCurrentTabContent(project) {
  if (_Sidebar__WEBPACK_IMPORTED_MODULE_0__.currentTab === "Inbox") {
    (0,_Sidebar__WEBPACK_IMPORTED_MODULE_0__.addAllTasks)();
  } else if (_Sidebar__WEBPACK_IMPORTED_MODULE_0__.currentTab === "Today") {
    (0,_Sidebar__WEBPACK_IMPORTED_MODULE_0__.addTodayTasks)();
...
function getCurrentProjectIndex(project) {
  return _Sidebar__WEBPACK_IMPORTED_MODULE_0__.projectList.findIndex(function (proj) {
...
/* harmony export */   "addTodayTasks": () => (/* binding */ addTodayTasks),
/* harmony export */   "addUpcomingTasks": () => (/* binding */ addUpcomingTasks),
/* harmony export */   "clearSectionContainer": () => (/* binding */ clearSectionContainer),
...
/* harmony import */ var _assets_upcoming_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../assets/upcoming.png */ "./src/assets/upcoming.png");
...
function sideBarItem(icon, name, id) {
  ...
  sideBarItem.id = id;
  var sideBarItemImage = new Image();
  sideBarItemImage.src = icon;
  sideBarItemImage.classList.add("sidebar__icon");
  var sideBarItemText = document.createElement("p");
...
function addAllTasks() {
  ...
  (0,_ProjectSection__WEBPACK_IMPORTED_MODULE_6__.removeTasks)();
  setCurrentTab("Inbox");
  (0,_ProjectSection__WEBPACK_IMPORTED_MODULE_6__.createPageHeader)("Inbox");
  var currentProjectList = JSON.parse(localStorage.getItem("projectListStorage"));
  currentProjectList.forEach(function (project) {
    (0,_ProjectSection__WEBPACK_IMPORTED_MODULE_6__.ShowProjectContent)(project);
  });
}
function addTodayTasks() {
  ...
  (0,_ProjectSection__WEBPACK_IMPORTED_MODULE_6__.removeTasks)();
  setCurrentTab("Today");
  (0,_ProjectSection__WEBPACK_IMPORTED_MODULE_6__.createPageHeader)("Today");
  projectList.forEach(function (project) {
    (0,_ProjectSection__WEBPACK_IMPORTED_MODULE_6__.ShowProjectContent)(project, true, false);
  });
}
function addUpcomingTasks() {
  ...
  (0,_ProjectSection__WEBPACK_IMPORTED_MODULE_6__.createPageHeader)("Upcoming");
  projectList.forEach(function (project) {
    (0,_ProjectSection__WEBPACK_IMPORTED_MODULE_6__.ShowProjectContent)(project, false, true);
  });
}
...
function addProjectInput() {
  ...
  var addProjectIcon = new Image();
  addProjectIcon.src = _assets_project_png__WEBPACK_IMPORTED_MODULE_3__;
  addProjectIcon.classList.add("sidebar__icon");
  addProjectInputContainer.append(addProjectIcon, addProjectInput);
  var addProjectInputRow = document.createElement("div");
  addProjectInputRow.classList.add("sidebar__input--row", "addProjectInput");
  addProjectInputRow.append(addProjectInputContainer, addProjectButtons(addProjectInput));
  return addProjectInputRow;
}
function updateProjectInput(userInput, taskID, projectContainer, projectHeader) {
  var addProjectInputRow = document.createElement("div");
  var _createAddProjectInpu = createAddProjectInputContainer(userInput),
    addProjectInputContainer = _createAddProjectInpu.addProjectInputContainer,
    addProjectInput = _createAddProjectInpu.addProjectInput;
  addProjectInputRow.classList.add("sidebar__input--row", "addProjectInput");
...
function addProjectButtons(input) {
  ...
  var projectContainer = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : document.querySelector(".project__container");
  var projectHeader = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : document.querySelector(".project__header");
  console.log(projectContainer, projectHeader);
  var _createAddProjectButt = createAddProjectButtons(),
    addProjectInputButtons = _createAddProjectButt.addProjectInputButtons,
    addProjectCancelBtn = _createAddProjectButt.addProjectCancelBtn,
    addProjectSaveBtn = _createAddProjectButt.addProjectSaveBtn;
  input.oninput = function () {
    setSaveButtonState(addProjectSaveBtn, input);
  };
  var currentProjectList = JSON.parse(localStorage.getItem("projectListStorage"));
  var findCurrentProject = currentProjectList.find(function (project) {
    return project.Id === taskID;
  });
  addProjectSaveBtn.onclick = function () {
    if (edit) {
...
function addProjectsToDOM() {
  ...
  currentProjectList.forEach(function (project) {
    var _createProjectItems = createProjectItems(project),
      ProjectInputContainer = _createProjectItems.ProjectInputContainer;
...
function removeFromProjectList(input) {
  var projectIndex = projectList.findIndex(function (project) {
    return project.title === input;
  });
...
function appendSideBarItems(sidebar) {
  createSideBarItems().forEach(function (element) {
...
function removeItem() {
  for (var _len2 = arguments.length, item = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
...
function createAddProjectInputContainer() {
  ...
  addProjectInputContainer.append(addProjectIcon, addProjectInput);
  return {
    addProjectInputContainer: addProjectInputContainer,
    addProjectInput: addProjectInput
  };
}
function createAddProjectButtons() {
  var addProjectSaveBtn = document.createElement("button");
  addProjectSaveBtn.classList.add("sidebar__button", "sidebar__button--primary");
  ...
  var addProjectInputButtons = document.createElement("div");
  ...
  return {
    addProjectInputButtons: addProjectInputButtons,
    addProjectCancelBtn: addProjectCancelBtn,
    addProjectSaveBtn: addProjectSaveBtn
  };
}
...
function createProjectItems(project) {
  ...
  ProjectInputContainer.classList.add("sidebar__input--container", "sidebar__input--container--output", "sidebar__item");
  var ProjectInput = document.createElement("p");
  ProjectInput.textContent = project.title;
  ProjectInput.classList.add("sidebar__input");
  var ProjectIcon = new Image();
  ProjectIcon.src = _assets_project_png__WEBPACK_IMPORTED_MODULE_3__;
  ProjectIcon.classList.add("sidebar__icon");
  var ProjectOptions = document.createElement("div");
  ProjectOptions.classList.add("sidebar__project--option", "hidden");
  var ProjectEdit = new Image();
  ProjectEdit.src = _assets_edit_png__WEBPACK_IMPORTED_MODULE_4__;
  ProjectEdit.classList.add("sidebar__icon", "sidebar__icon--small");
  var ProjectDelete = new Image();
  ProjectDelete.src = _assets_delete_png__WEBPACK_IMPORTED_MODULE_5__;
  ProjectDelete.classList.add("sidebar__icon", "sidebar__icon--small");
  ProjectOptions.append(ProjectEdit, ProjectDelete);
  ProjectInputContainer.append(ProjectIcon, ProjectInput, ProjectOptions);
  ProjectInputContainer.onmouseover = function () {
  ...
  ProjectEdit.onclick = function (e) {
    ...
    projectGroup.insertBefore(updateProjectInput(project.title, project.Id), currentItem);
    currentItem.remove();
    e.stopPropagation();
    populateStorage();
  };
  ProjectDelete.onclick = function (e) {
    // remove from dom
...
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/priority.svg */ "./src/assets/priority.svg"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Inter:wght@200;300;400;700;800&display=swap);"]);
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
var ___CSS_LOADER_URL_REPLACEMENT_1___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_1___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@charset \"UTF-8\";\nbody {\n  font-family: Inter, sans-serif;\n  position: relative;\n  height: 100vh;\n  width: 100vw;\n  overflow-x: hidden;\n}\n\n#container {\n  margin: 0;\n  padding: 0;\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  flex-direction: column;\n}\n\n.section {\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n}\n.section--main {\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-self: center;\n  margin: auto;\n  width: max(60%, 500px);\n  padding: 3em 0;\n}\n\n.project {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n  width: 100%;\n}\n.project__text--title {\n  height: fit-content;\n  width: 100%;\n  padding-bottom: 0.25em;\n  padding: 0;\n  margin-block-end: 0.25em;\n}\n.project__text--prompt {\n  text-align: center;\n}\n.project__text--header {\n  font-size: 1.5rem;\n  border-bottom: solid 1px #e4e4e4;\n  display: flex;\n  justify-content: space-between;\n}\n.project__button {\n  appearance: none;\n  border: none;\n  outline: none;\n}\n.project__button--add {\n  height: 60px;\n  width: 200px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 30px;\n  gap: 1em;\n  flex-direction: row-reverse;\n  background-color: #db4c3f;\n  color: white;\n  font-size: 1.15rem;\n  margin: 0 auto;\n}\n.project__button--add:hover {\n  background-color: #bd453a;\n  cursor: pointer;\n}\n.project__container {\n  padding-left: 1.5em;\n}\n.project__header {\n  display: flex;\n  align-items: center;\n  width: 100%;\n  border-bottom: solid 1px #e4e4e4;\n}\n\n.navbar {\n  display: flex;\n  align-items: center;\n  padding: 0 2rem;\n  width: 100vw;\n  background-color: #db4c3f;\n  color: white;\n  z-index: 2;\n}\n.navbar__menu {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 40px;\n  width: 40px;\n  transition: background-color 0.5s;\n  border-radius: 10px;\n}\n.navbar__menu:hover {\n  background-color: #bd453a;\n  cursor: pointer;\n}\n.navbar h2 {\n  padding: 0.5em;\n  margin: auto;\n}\n\n.sidebar {\n  width: 270px;\n  height: 100vh;\n  background-color: #fafafa;\n  flex-direction: column;\n  padding: 2rem 2rem 2rem 1rem;\n  justify-content: flex-start;\n  transition: ease-in-out left 0.35s;\n  transition: ease-in-out all 0.35s;\n  margin-left: 0;\n}\n.sidebar__item {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  width: inherit;\n  flex-basis: 100%;\n  transition: background-color 0.5s;\n  border-radius: 10px;\n}\n.sidebar__item:hover {\n  cursor: pointer;\n  background-color: #e9e8e8;\n}\n.sidebar__icon {\n  height: 26px;\n  padding-left: 16px;\n}\n.sidebar__icon--small {\n  padding: 0;\n  height: 22px;\n  border-radius: 10px;\n  transition: ease-in 0.25s;\n  padding: 0.25em;\n}\n.sidebar__icon--small:hover {\n  background-color: #fff;\n  cursor: pointer;\n}\n.sidebar__text--main {\n  margin-top: 2em;\n}\n.sidebar__button {\n  width: 35%;\n  appearance: none;\n  background: transparent;\n  border: 1px solid #bcb3b3;\n  border-radius: 10px;\n  padding: 0.4em;\n  transition: ease-in-out background-color 0.25s;\n}\n.sidebar__button:hover {\n  cursor: pointer;\n  background-color: #e9e8e8;\n}\n.sidebar__button--add {\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  flex-direction: row-reverse;\n  gap: 1rem;\n  background-color: transparent;\n  border: none;\n  padding: 1rem;\n  color: #837d7d;\n  width: 100%;\n  transition: background-color 0.5s, color 0.5s;\n  border-radius: 10px;\n}\n.sidebar__button--add:hover {\n  cursor: pointer;\n  background-color: #e9e8e8;\n  color: #db4c3f;\n}\n.sidebar__button--container {\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  gap: 0.5em;\n}\n.sidebar__button--primary {\n  background-color: #db4c3f;\n  color: white;\n  border-color: #db4c3f;\n  opacity: 1;\n}\n.sidebar__button--primary:hover {\n  background-color: #bd453a;\n}\n.sidebar__button--primary:disabled {\n  opacity: 0.5;\n}\n.sidebar--open {\n  margin-left: -320px;\n}\n.sidebar__input {\n  width: 80%;\n  border: none;\n  background-color: transparent;\n}\n.sidebar__input:focus, .sidebar__input:active {\n  border: none;\n  outline: none;\n}\n.sidebar__input--container {\n  display: flex;\n  gap: 1em;\n  border: 1px solid #bcb3b3;\n  border-radius: 10px;\n  padding: 0.5em 0;\n}\n.sidebar__input--container--output {\n  padding: 0;\n  padding-right: 8px;\n  align-items: center;\n  border: none;\n}\n.sidebar__input--row {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5em;\n  width: 100%;\n}\n.sidebar__project--option {\n  display: flex;\n  gap: 0.25em;\n}\n\n.hidden {\n  opacity: 0;\n}\n\n.task__container {\n  display: flex;\n  flex-direction: column;\n  border: 2px solid #d7d5d5;\n  border-radius: 10px;\n  padding: 8px 16px;\n  margin-top: 1em;\n}\n.task__container--select {\n  display: flex;\n  border: none;\n  gap: 2em;\n}\n.task__container--options {\n  flex-direction: row;\n  border: none;\n  justify-content: flex-end;\n  gap: 1em;\n  padding: 8px 0;\n}\n.task__container--item {\n  border: none;\n  border-radius: 0;\n  border-bottom: 1px solid #d7d5d5;\n  flex-direction: row;\n  padding: 16px 0;\n}\n.task__container--text {\n  width: 100%;\n}\n.task__input {\n  appearance: none;\n  border: none;\n  outline: none;\n  padding: 2px;\n  border-radius: 10px;\n  border-color: #bcb3b3;\n}\n.task__input--title, .task__input--name, .task__input--name::placeholder, .task__input--title::placeholder {\n  margin: 0;\n  font-size: 1.15rem;\n  font-weight: 600;\n  border-bottom: 3px solid white;\n  border-radius: 0;\n}\n.task__input--name {\n  padding: 0 0 0 8px;\n}\n.task__input--select {\n  border: 2px solid #d7d5d5;\n  padding-right: 1em;\n  font-size: 1em;\n}\n.task__input--prio {\n  padding-left: 2em;\n}\n.task__input--textarea {\n  color: #837d7d;\n  height: 80px;\n  resize: none;\n}\n.task__input--desc {\n  color: #837d7d;\n  height: auto;\n  padding: 8px;\n  margin: 0;\n}\n.task__input--invalid {\n  border-color: #d1453b;\n}\n.task__input--shake {\n  animation: horizontal-shaking 0.5s;\n}\n.task__input--checkbox {\n  height: 1.15em;\n  width: 1.35em;\n  border-radius: 20px;\n  background: #faeceb;\n  border: 2px solid #d1453b;\n  flex-shrink: 0;\n}\n.task__input--checkbox:checked, .task__input--checkbox:hover {\n  cursor: pointer;\n}\n.task__input--checkbox:checked::before, .task__input--checkbox:hover::before {\n  content: \"✔\";\n  color: #d1453b;\n  display: flex;\n  height: 100%;\n  font-size: 10px;\n  align-items: center;\n  justify-content: center;\n  transform: all ease-in;\n}\n.task__input--medium {\n  border-color: #eb8909;\n}\n.task__input--medium::before {\n  color: #eb8909;\n}\n.task__input--low {\n  border-color: #837d7d;\n}\n.task__input--low::before {\n  color: #837d7d;\n}\n.task__button {\n  width: 35%;\n  appearance: none;\n  background: transparent;\n  border: 1px solid #bcb3b3;\n  border-radius: 10px;\n  padding: 0.4em;\n  transition: ease-in-out background-color 0.25s;\n  width: 20%;\n}\n.task__button:hover {\n  cursor: pointer;\n  background-color: #e9e8e8;\n}\n.task__button--add {\n  background-color: #db4c3f;\n  color: white;\n  border-color: #db4c3f;\n  opacity: 1;\n}\n.task__button--add:hover {\n  background-color: #bd453a;\n}\n.task__button--add:disabled {\n  opacity: 0.5;\n}\n.task__option--icon {\n  font-family: \"Material Symbols Outlined\";\n}\n\ninput[type=checkbox] {\n  appearance: none;\n  margin-top: 2px;\n}\n\ninput[type=date] {\n  display: flex;\n  flex-direction: row-reverse;\n  padding-left: 12px;\n  gap: 0.35em;\n  color: #249442;\n}\ninput[type=date]::-webkit-calendar-picker-indicator {\n  display: block;\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat;\n  border-width: thin;\n}\ninput[type=date]:disabled {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat;\n  background-position: 0.75em center;\n}\n\nselect {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n  background-repeat: no-repeat;\n  background-position: 0.4em center;\n  font-size: 1.5em;\n  appearance: none;\n  color: #837d7d;\n}\nselect option {\n  appearance: none;\n}\nselect:disabled {\n  opacity: 1;\n}\n\n.option {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n  background-position: 0.4em center;\n}\n.option--high {\n  color: #d1453b;\n}\n.option--medium {\n  color: #eb8909;\n}\n\n@keyframes horizontal-shaking {\n  0% {\n    transform: translateX(0);\n  }\n  25% {\n    transform: translateX(5px);\n  }\n  50% {\n    transform: translateX(-5px);\n  }\n  75% {\n    transform: translateX(5px);\n  }\n  100% {\n    transform: translateX(0);\n  }\n}\n@media screen and (max-width: 450px) {\n  .section--main {\n    width: 80%;\n  }\n  .task__container--text {\n    width: 70%;\n  }\n  .task__container--select {\n    margin-top: 1em;\n    flex-wrap: wrap;\n    gap: 0.5em;\n  }\n  .task__button {\n    width: auto;\n  }\n  .sidebar--open {\n    margin-right: 2rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/styles/style.scss"],"names":[],"mappings":"AAAA,gBAAgB;AAGhB;EACE,8BAAA;EACA,kBAAA;EACA,aAAA;EACA,YAAA;EACA,kBAAA;AAAF;;AAyDA;EACE,SAAA;EACA,UAAA;EACA,aAAA;EACA,YAAA;EAGA,aAAA;EACA,sBAAA;AAxDF;;AA2DA;EACE,aAAA;EACA,YAAA;EACA,aAAA;AAxDF;AA2DE;EACE,YAAA;EACA,aAAA;EACA,sBAAA;EACA,oBAAA;EACA,YAAA;EAEA,sBAAA;EACA,cAAA;AA1DJ;;AAkEA;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,sBAAA;EACA,WAAA;AA/DF;AAkEI;EACE,mBAAA;EACA,WAAA;EACA,sBAAA;EACA,UAAA;EACA,wBAAA;AAhEN;AAmEI;EACE,kBAAA;AAjEN;AAoEI;EACE,iBAAA;EACA,gCAAA;EACA,aAAA;EACA,8BAAA;AAlEN;AAsEE;EACE,gBAAA;EACA,YAAA;EACA,aAAA;AApEJ;AAqEI;EACE,YAAA;EACA,YAAA;EAxHJ,aAAA;EACA,mBAAA;EAyHI,uBAAA;EACA,mBAAA;EACA,QAAA;EACA,2BAAA;EACA,yBAzIU;EA0IV,YAAA;EACA,kBAAA;EACA,cAAA;AAlEN;AAoEM;EACE,yBAAA;EACA,eAAA;AAlER;AAuEE;EACE,mBAAA;AArEJ;AAwEE;EACE,aAAA;EACA,mBAAA;EACA,WAAA;EACA,gCAAA;AAtEJ;;AA2EA;EAvJE,aAAA;EACA,mBAAA;EAwJA,eAAA;EAEA,YAAA;EACA,yBAvKc;EAwKd,YAAA;EACA,UAAA;AAxEF;AA0EE;EAhKA,aAAA;EACA,mBAAA;EAiKE,uBAAA;EACA,YAAA;EACA,WAAA;EACA,iCAAA;EACA,mBAAA;AAvEJ;AAyEI;EACE,yBAAA;EACA,eAAA;AAvEN;AA2EE;EAEE,cAAA;EACA,YAAA;AA1EJ;;AA8EA;EACE,YAAA;EACA,aAAA;EACA,yBAAA;EACA,sBAAA;EAEA,4BAAA;EACA,2BAAA;EAKA,kCAAA;EACA,iCAAA;EAEA,cAAA;AAjFF;AAmFE;EAtMA,aAAA;EACA,mBAAA;EAuME,SAAA;EACA,cAAA;EACA,gBAAA;EACA,iCAAA;EACA,mBAAA;AAhFJ;AAkFI;EAzMF,eAAA;EACA,yBAAA;AA0HF;AAmFE;EACE,YAAA;EACA,kBAAA;AAjFJ;AAmFI;EACE,UAAA;EACA,YAAA;EACA,mBAAA;EACA,yBAAA;EACA,eAAA;AAjFN;AAkFM;EACE,sBAAA;EACA,eAAA;AAhFR;AAsFI;EACE,eAAA;AApFN;AAwFE;EAhOA,UAAA;EACA,gBAAA;EACA,uBAAA;EACA,yBAAA;EACA,mBAAA;EACA,cAAA;EACA,8CAAA;AA2IF;AA1IE;EAZA,eAAA;EACA,yBAAA;AAyJF;AA6EI;EA5OF,aAAA;EACA,mBAAA;EAuBA,yBAAA;EACA,2BAAA;EACA,SAAA;EACA,6BAAA;EACA,YAAA;EACA,aAAA;EACA,cAAA;EACA,WAAA;EACA,6CAAA;EACA,mBAAA;AA4IF;AA3IE;EA7BA,eAAA;EACA,yBAAA;EA8BE,cA/CY;AA6LhB;AA8DI;EAhPF,aAAA;EACA,mBAAA;EAiPI,yBAAA;EACA,UAAA;AA3DN;AA8DI;EA7MF,yBApDc;EAqDd,YAAA;EACA,qBAtDc;EAuDd,UAAA;AAkJF;AAjJE;EACE,yBAAA;AAmJJ;AAjJE;EACE,YAAA;AAmJJ;AAuDE;EAEE,mBAAA;AAtDJ;AAyDE;EACE,UAAA;EACA,YAAA;EACA,6BAAA;AAvDJ;AAyDI;EAEE,YAAA;EACA,aAAA;AAxDN;AA0DI;EACE,aAAA;EACA,QAAA;EACA,yBAAA;EACA,mBAAA;EACA,gBAAA;AAxDN;AA0DM;EACE,UAAA;EACA,kBAAA;EACA,mBAAA;EACA,YAAA;AAxDR;AA4DI;EACE,aAAA;EACA,sBAAA;EACA,UAAA;EACA,WAAA;AA1DN;AA8DE;EACE,aAAA;EACA,WAAA;AA5DJ;;AAgEA;EACE,UAAA;AA7DF;;AAkEE;EACE,aAAA;EACA,sBAAA;EACA,yBAAA;EACA,mBAAA;EACA,iBAAA;EAEA,eAAA;AAhEJ;AAiEI;EACE,aAAA;EACA,YAAA;EACA,QAAA;AA/DN;AAkEI;EACE,mBAAA;EACA,YAAA;EACA,yBAAA;EACA,QAAA;EACA,cAAA;AAhEN;AAmEI;EACE,YAAA;EACA,gBAAA;EACA,gCAAA;EACA,mBAAA;EACA,eAAA;AAjEN;AAoEI;EACE,WAAA;AAlEN;AAsEE;EACE,gBAAA;EACA,YAAA;EACA,aAAA;EACA,YAAA;EACA,mBAAA;EACA,qBAAA;AApEJ;AAsEI;EACE,SAAA;EACA,kBAAA;EACA,gBAAA;EACA,8BAAA;EACA,gBAAA;AApEN;AA2EI;EACE,kBAAA;AAzEN;AA4EI;EACE,yBAAA;EACA,kBAAA;EACA,cAAA;AA1EN;AA6EI;EACE,iBAAA;AA3EN;AA8EI;EACE,cAAA;EACA,YAAA;EACA,YAAA;AA5EN;AA+EI;EACE,cAAA;EACA,YAAA;EACA,YAAA;EACA,SAAA;AA7EN;AA+EI;EACE,qBAAA;AA7EN;AAgFI;EACE,kCAAA;AA9EN;AAiFI;EACE,cAAA;EACA,aAAA;EACA,mBAAA;EACA,mBAAA;EACA,yBAAA;EACA,cAAA;AA/EN;AAgFM;EAEE,eAAA;AA/ER;AAiFQ;EACE,YAAA;EACA,cAAA;EACA,aAAA;EACA,YAAA;EACA,eAAA;EACA,mBAAA;EACA,uBAAA;EACA,sBAAA;AA/EV;AAoFI;EACE,qBAAA;AAlFN;AAoFM;EACE,cAAA;AAlFR;AAsFI;EACE,qBAAA;AApFN;AAqFM;EACE,cAAA;AAnFR;AAwFE;EApaA,UAAA;EACA,gBAAA;EACA,uBAAA;EACA,yBAAA;EACA,mBAAA;EACA,cAAA;EACA,8CAAA;EAgaE,UAAA;AAhFJ;AA/UE;EAZA,eAAA;EACA,yBAAA;AA8VF;AA6EI;EAxYF,yBApDc;EAqDd,YAAA;EACA,qBAtDc;EAuDd,UAAA;AA8TF;AA7TE;EACE,yBAAA;AA+TJ;AA7TE;EACE,YAAA;AA+TJ;AAuEI;EACE,wCAAA;AArEN;;AA0EA;EACE,gBAAA;EACA,eAAA;AAvEF;;AAyEA;EACE,aAAA;EACA,2BAAA;EACA,kBAAA;EACA,WAAA;EACA,cAAA;AAtEF;AAwEE;EACE,cAAA;EACA,6DAAA;EACA,kBAAA;AAtEJ;AAyEE;EACE,6DAAA;EACA,kCAAA;AAvEJ;;AAkFA;EACE,yDAAA;EACA,4BAAA;EAEA,iCAAA;EACA,gBAAA;EACA,gBAAA;EACA,cAAA;AAhFF;AAkFE;EACE,gBAAA;AAhFJ;AAmFE;EACE,UAAA;AAjFJ;;AAqFA;EACE,yDAAA;EACA,iCAAA;AAlFF;AAmFE;EACE,cAAA;AAjFJ;AAoFE;EACE,cAAA;AAlFJ;;AAsFA;EACE;IACE,wBAAA;EAnFF;EAqFA;IACE,0BAAA;EAnFF;EAqFA;IACE,2BAAA;EAnFF;EAqFA;IACE,0BAAA;EAnFF;EAqFA;IACE,wBAAA;EAnFF;AACF;AAwFA;EAEI;IAEE,UAAA;EAxFJ;EA8FI;IACE,UAAA;EA5FN;EA+FI;IACE,eAAA;IACA,eAAA;IACA,UAAA;EA7FN;EAiGE;IACE,WAAA;EA/FJ;EAmGA;IACE,kBAAA;EAjGF;AACF","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Inter:wght@200;300;400;700;800&display=swap\");\r\n$color-primary: #db4c3f;\r\n\r\nbody {\r\n  font-family: Inter, sans-serif;\r\n  position: relative;\r\n  height: 100vh;\r\n  width: 100vw;\r\n  overflow-x: hidden;\r\n}\r\n\r\n@mixin flexCenter() {\r\n  display: flex;\r\n  align-items: center;\r\n}\r\n\r\n@mixin hover() {\r\n  cursor: pointer;\r\n  background-color: #e9e8e8;\r\n}\r\n\r\n@mixin buttonStyling() {\r\n  width: 35%;\r\n  appearance: none;\r\n  background: transparent;\r\n  border: 1px solid #bcb3b3;\r\n  border-radius: 10px;\r\n  padding: 0.4em;\r\n  transition: ease-in-out background-color 0.25s;\r\n  &:hover {\r\n    @include hover();\r\n  }\r\n}\r\n\r\n@mixin buttonAddTaskStyling() {\r\n  @include flexCenter();\r\n  justify-content: flex-end;\r\n  flex-direction: row-reverse;\r\n  gap: 1rem;\r\n  background-color: transparent;\r\n  border: none;\r\n  padding: 1rem;\r\n  color: #837d7d;\r\n  width: 100%;\r\n  transition: background-color 0.5s, color 0.5s;\r\n  border-radius: 10px;\r\n  &:hover {\r\n    @include hover();\r\n    color: $color-primary;\r\n  }\r\n}\r\n\r\n@mixin buttonPrimaryStyling {\r\n  background-color: $color-primary;\r\n  color: white;\r\n  border-color: $color-primary;\r\n  opacity: 1;\r\n  &:hover {\r\n    background-color: #bd453a;\r\n  }\r\n  &:disabled {\r\n    opacity: 0.5;\r\n  }\r\n}\r\n\r\n#container {\r\n  margin: 0;\r\n  padding: 0;\r\n  height: 100vh;\r\n  width: 100vw;\r\n  // position: relative;\r\n\r\n  display: flex;\r\n  flex-direction: column;\r\n}\r\n\r\n.section {\r\n  height: 100vh;\r\n  width: 100vw;\r\n  display: flex;\r\n  // justify-content: center;\r\n\r\n  &--main {\r\n    height: 100%;\r\n    display: flex;\r\n    flex-direction: column;\r\n    justify-self: center;\r\n    margin: auto;\r\n    // width: clamp(80%, 450px, 20vw);\r\n    width: max(60%, 500px);\r\n    padding: 3em 0;\r\n    // background-color: red;\r\n    // align-items: center;\r\n\r\n    // margin: 0 auto;\r\n  }\r\n}\r\n\r\n.project {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  flex-direction: column;\r\n  width: 100%;\r\n\r\n  &__text {\r\n    &--title {\r\n      height: fit-content;\r\n      width: 100%;\r\n      padding-bottom: 0.25em;\r\n      padding: 0;\r\n      margin-block-end: 0.25em;\r\n    }\r\n\r\n    &--prompt {\r\n      text-align: center;\r\n    }\r\n\r\n    &--header {\r\n      font-size: 1.5rem;\r\n      border-bottom: solid 1px #e4e4e4;\r\n      display: flex;\r\n      justify-content: space-between;\r\n    }\r\n  }\r\n\r\n  &__button {\r\n    appearance: none;\r\n    border: none;\r\n    outline: none;\r\n    &--add {\r\n      height: 60px;\r\n      width: 200px;\r\n      @include flexCenter();\r\n      justify-content: center;\r\n      border-radius: 30px;\r\n      gap: 1em;\r\n      flex-direction: row-reverse;\r\n      background-color: $color-primary;\r\n      color: white;\r\n      font-size: 1.15rem;\r\n      margin: 0 auto;\r\n\r\n      &:hover {\r\n        background-color: #bd453a;\r\n        cursor: pointer;\r\n      }\r\n    }\r\n  }\r\n\r\n  &__container {\r\n    padding-left: 1.5em;\r\n  }\r\n\r\n  &__header {\r\n    display: flex;\r\n    align-items: center;\r\n    width: 100%;\r\n    border-bottom: solid 1px #e4e4e4;\r\n  }\r\n}\r\n\r\n// TODO: adjust margin-left\r\n.navbar {\r\n  @include flexCenter();\r\n  padding: 0 2rem;\r\n  // gap: 45vw;\r\n  width: 100vw;\r\n  background-color: $color-primary;\r\n  color: white;\r\n  z-index: 2;\r\n  // justify-content: none;\r\n  &__menu {\r\n    @include flexCenter();\r\n    justify-content: center;\r\n    height: 40px;\r\n    width: 40px;\r\n    transition: background-color 0.5s;\r\n    border-radius: 10px;\r\n\r\n    &:hover {\r\n      background-color: #bd453a;\r\n      cursor: pointer;\r\n    }\r\n  }\r\n\r\n  h2 {\r\n    // justify-self: center;\r\n    padding: 0.5em;\r\n    margin: auto;\r\n  }\r\n}\r\n\r\n.sidebar {\r\n  width: 270px;\r\n  height: 100vh;\r\n  background-color: #fafafa;\r\n  flex-direction: column;\r\n  // padding: 8rem 2rem 2rem 1rem;\r\n  padding: 2rem 2rem 2rem 1rem;\r\n  justify-content: flex-start;\r\n  // z-index: 1;\r\n  // position: absolute;\r\n  // top: 0;\r\n  // left: -270px;\r\n  transition: ease-in-out left 0.35s;\r\n  transition: ease-in-out all 0.35s;\r\n  // margin-left: -320px;\r\n  margin-left: 0;\r\n  // justify-self: flex-start;\r\n  &__item {\r\n    @include flexCenter();\r\n    gap: 1rem;\r\n    width: inherit;\r\n    flex-basis: 100%;\r\n    transition: background-color 0.5s;\r\n    border-radius: 10px;\r\n\r\n    &:hover {\r\n      @include hover();\r\n    }\r\n  }\r\n\r\n  &__icon {\r\n    height: 26px;\r\n    padding-left: 16px;\r\n\r\n    &--small {\r\n      padding: 0;\r\n      height: 22px;\r\n      border-radius: 10px;\r\n      transition: ease-in 0.25s;\r\n      padding: 0.25em;\r\n      &:hover {\r\n        background-color: #fff;\r\n        cursor: pointer;\r\n      }\r\n    }\r\n  }\r\n\r\n  &__text {\r\n    &--main {\r\n      margin-top: 2em;\r\n    }\r\n  }\r\n\r\n  &__button {\r\n    @include buttonStyling();\r\n    &--add {\r\n      @include buttonAddTaskStyling();\r\n    }\r\n\r\n    &--container {\r\n      @include flexCenter();\r\n      justify-content: flex-end;\r\n      gap: 0.5em;\r\n    }\r\n\r\n    &--primary {\r\n      @include buttonPrimaryStyling();\r\n    }\r\n  }\r\n\r\n  &--open {\r\n    // left: 0;\r\n    margin-left: -320px;\r\n  }\r\n\r\n  &__input {\r\n    width: 80%;\r\n    border: none;\r\n    background-color: transparent;\r\n\r\n    &:focus,\r\n    &:active {\r\n      border: none;\r\n      outline: none;\r\n    }\r\n    &--container {\r\n      display: flex;\r\n      gap: 1em;\r\n      border: 1px solid #bcb3b3;\r\n      border-radius: 10px;\r\n      padding: 0.5em 0;\r\n\r\n      &--output {\r\n        padding: 0;\r\n        padding-right: 8px;\r\n        align-items: center;\r\n        border: none;\r\n      }\r\n    }\r\n\r\n    &--row {\r\n      display: flex;\r\n      flex-direction: column;\r\n      gap: 0.5em;\r\n      width: 100%;\r\n    }\r\n  }\r\n\r\n  &__project--option {\r\n    display: flex;\r\n    gap: 0.25em;\r\n  }\r\n}\r\n\r\n.hidden {\r\n  opacity: 0;\r\n}\r\n\r\n// TODO: Finalize Styling\r\n.task {\r\n  &__container {\r\n    display: flex;\r\n    flex-direction: column;\r\n    border: 2px solid #d7d5d5;\r\n    border-radius: 10px;\r\n    padding: 8px 16px;\r\n    // gap: 0.75em;\r\n    margin-top: 1em;\r\n    &--select {\r\n      display: flex;\r\n      border: none;\r\n      gap: 2em;\r\n    }\r\n\r\n    &--options {\r\n      flex-direction: row;\r\n      border: none;\r\n      justify-content: flex-end;\r\n      gap: 1em;\r\n      padding: 8px 0;\r\n    }\r\n\r\n    &--item {\r\n      border: none;\r\n      border-radius: 0;\r\n      border-bottom: 1px solid #d7d5d5;\r\n      flex-direction: row;\r\n      padding: 16px 0;\r\n    }\r\n\r\n    &--text {\r\n      width: 100%;\r\n    }\r\n  }\r\n\r\n  &__input {\r\n    appearance: none;\r\n    border: none;\r\n    outline: none;\r\n    padding: 2px;\r\n    border-radius: 10px;\r\n    border-color: #bcb3b3;\r\n\r\n    &--title {\r\n      margin: 0;\r\n      font-size: 1.15rem;\r\n      font-weight: 600;\r\n      border-bottom: 3px solid white;\r\n      border-radius: 0;\r\n\r\n      &::placeholder {\r\n        @extend .task__input--title;\r\n      }\r\n    }\r\n\r\n    &--name {\r\n      padding: 0 0 0 8px;\r\n      @extend .task__input--title;\r\n    }\r\n    &--select {\r\n      border: 2px solid #d7d5d5;\r\n      padding-right: 1em;\r\n      font-size: 1em;\r\n    }\r\n\r\n    &--prio {\r\n      padding-left: 2em;\r\n    }\r\n\r\n    &--textarea {\r\n      color: #837d7d;\r\n      height: 80px;\r\n      resize: none;\r\n    }\r\n\r\n    &--desc {\r\n      color: #837d7d;\r\n      height: auto;\r\n      padding: 8px;\r\n      margin: 0;\r\n    }\r\n    &--invalid {\r\n      border-color: #d1453b;\r\n    }\r\n\r\n    &--shake {\r\n      animation: horizontal-shaking 0.5s;\r\n    }\r\n\r\n    &--checkbox {\r\n      height: 1.15em;\r\n      width: 1.35em;\r\n      border-radius: 20px;\r\n      background: #faeceb;\r\n      border: 2px solid #d1453b;\r\n      flex-shrink: 0;\r\n      &:checked,\r\n      &:hover {\r\n        cursor: pointer;\r\n\r\n        &::before {\r\n          content: \"✔\";\r\n          color: #d1453b;\r\n          display: flex;\r\n          height: 100%;\r\n          font-size: 10px;\r\n          align-items: center;\r\n          justify-content: center;\r\n          transform: all ease-in;\r\n        }\r\n      }\r\n    }\r\n\r\n    &--medium {\r\n      border-color: #eb8909;\r\n\r\n      &::before {\r\n        color: #eb8909;\r\n      }\r\n    }\r\n\r\n    &--low {\r\n      border-color: #837d7d;\r\n      &::before {\r\n        color: #837d7d;\r\n      }\r\n    }\r\n  }\r\n\r\n  &__button {\r\n    @include buttonStyling();\r\n    width: 20%;\r\n    &--add {\r\n      @include buttonPrimaryStyling();\r\n    }\r\n  }\r\n\r\n  &__option {\r\n    &--icon {\r\n      font-family: \"Material Symbols Outlined\";\r\n    }\r\n  }\r\n}\r\n\r\ninput[type=\"checkbox\"] {\r\n  appearance: none;\r\n  margin-top: 2px;\r\n}\r\ninput[type=\"date\"] {\r\n  display: flex;\r\n  flex-direction: row-reverse;\r\n  padding-left: 12px;\r\n  gap: 0.35em;\r\n  color: #249442;\r\n\r\n  &::-webkit-calendar-picker-indicator {\r\n    display: block;\r\n    background: url(../assets/calendar.svg) no-repeat;\r\n    border-width: thin;\r\n  }\r\n\r\n  &:disabled {\r\n    background: url(../assets/calendar.svg) no-repeat;\r\n    background-position: 0.75em center;\r\n  }\r\n}\r\n\r\n// input[type=\"date\"]::-webkit-calendar-picker-indicator {\r\n//   opacity: 1;\r\n//   display: block;\r\n//   background: url(../assets/calendar.svg) no-repeat;\r\n//   border-width: thin;\r\n// }\r\n\r\nselect {\r\n  background-image: url(\"../assets/priority.svg\");\r\n  background-repeat: no-repeat;\r\n\r\n  background-position: 0.4em center;\r\n  font-size: 1.5em;\r\n  appearance: none;\r\n  color: #837d7d;\r\n\r\n  option {\r\n    appearance: none;\r\n  }\r\n\r\n  &:disabled {\r\n    opacity: 1;\r\n  }\r\n}\r\n\r\n.option {\r\n  background-image: url(\"../assets/priority.svg\");\r\n  background-position: 0.4em center;\r\n  &--high {\r\n    color: #d1453b;\r\n  }\r\n\r\n  &--medium {\r\n    color: #eb8909;\r\n  }\r\n}\r\n\r\n@keyframes horizontal-shaking {\r\n  0% {\r\n    transform: translateX(0);\r\n  }\r\n  25% {\r\n    transform: translateX(5px);\r\n  }\r\n  50% {\r\n    transform: translateX(-5px);\r\n  }\r\n  75% {\r\n    transform: translateX(5px);\r\n  }\r\n  100% {\r\n    transform: translateX(0);\r\n  }\r\n}\r\n\r\n// TODO Style the UI\r\n\r\n@media screen and (max-width: 450px) {\r\n  .section {\r\n    &--main {\r\n      // background-color: red;\r\n      width: 80%;\r\n    }\r\n  }\r\n\r\n  .task {\r\n    &__container {\r\n      &--text {\r\n        width: 70%;\r\n      }\r\n\r\n      &--select {\r\n        margin-top: 1em;\r\n        flex-wrap: wrap;\r\n        gap: 0.5em;\r\n      }\r\n    }\r\n\r\n    &__button {\r\n      width: auto;\r\n    }\r\n  }\r\n\r\n  .sidebar--open {\r\n    margin-right: 2rem;\r\n  }\r\n}\r\n\r\n// TODO: CENTER THE TEXT\r\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
module.exports = __webpack_require__.p + "priority.svg";
...
module.exports = __webpack_require__.p + "project.png";
...
container.append((0,_components_Navbar__WEBPACK_IMPORTED_MODULE_2__["default"])());
(function createMainSection() {
  ...
  section.append((0,_components_Sidebar__WEBPACK_IMPORTED_MODULE_3__["default"])(), sectionContainer);
